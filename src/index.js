...
const fetchOptions = async () => {
    try {
        ...
        return [];
            ...
            registerBlockType('block-master/test-block-1-0', {
                title: 'Test-block-1-0',
                category: 'block-master',
                parent: ['block-master/test-block-1'],
                attributes: {
...
imgAlt_0: { type: 'string', default: 'rasm-uchun-text' }
        ...
        <InnerBlocks
    allowedBlocks={['block-master/test-block-1-0']}
    template={[
        ['block-master/test-block-1-0', {}],
    ]}/>
        </ul>
    </div>
    <div class="ds">
    ...
    <div class="ds">
        <span><RichText.Content value={attributes.text_2} /></span>
            ...
            registerBlockType('block-master/test-block-0-0', {
                title: 'Test-block-0-0',
                category: 'block-master',
                parent: ['block-master/test-block-0'],
                attributes: {
                    text_0: { type: 'string', default: '123' }
                },
                edit: ({ attributes, setAttributes }) => {
            ...
            registerBlockType('block-master/test-block-0', {
                title: 'Test-block-0',
                category: 'block-master',
                parent: ['block-master/test-block'],
                attributes: {
...
imgAlt_0: { type: 'string', default: 'rasm-uchun-text' }
        ...
        <InnerBlocks
    allowedBlocks={['block-master/test-block-0-0']}
    template={[
        ['block-master/test-block-0-0', {}],
    ]}/>
        </ul>
    </div>
    <div class="ds">
...
url_0: { type: 'string', default: 'test.php' }
    ...
    <InnerBlocks
    allowedBlocks={['block-master/test-block-0']}
    template={[
        ['block-master/test-block-0', {}],
    ]}/>
    <InnerBlocks
    allowedBlocks={['block-master/test-block-1']}
    template={[
        ['block-master/test-block-1', {}],
    ]}/>
</div>
                        </>
                    );
